...
export function TrainerSection({ trainer }: TrainerSectionProps) {
    return (
        <section className="space-y-8">
            <h2 className="text-2xl font-bold text-white tracking-tight">Meet the Instructor</h2>

            <div className="bg-white/3 border border-white/5 rounded-3xl p-8 group hover:border-purple-500/30 transition-all">
                <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                    ...
                    <div className="flex-1 space-y-4 text-center md:text-left">
                        <div className="space-y-1">
                            ...
                            <p className="text-purple-400/60 text-xs font-bold uppercase tracking-widest">
                        ...
                        <div className="flex flex-wrap justify-center md:justify-start gap-6 py-2">
                            <div className="flex items-center gap-2 text-sm text-gray-400">
                                ...
                                <span className="font-medium text-white text-xs uppercase tracking-wider">Top Rated</span>
                            </div>
                            <div className="flex items-center gap-2 text-sm text-gray-400">
                                <Award className="w-4 h-4 text-purple-500" />
                                <span className="font-medium text-white text-xs uppercase tracking-wider">Expert Instructor</span>
                            </div>
                        </div>
