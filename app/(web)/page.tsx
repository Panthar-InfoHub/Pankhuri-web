...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-zinc-50 via-white to-pink-50/30">
      {/* Hero Section */}
      ...
      {/* Categories Section */}
      <section className="max-w-7xl mx-auto px-6 pb-24 md:pb-32 pt-12 relative">
