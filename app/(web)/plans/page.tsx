    ...
    <main className="bg-zinc-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          {/* Yearly Plan */}
          {yearlyPlan && (
            <Card className="bg-linear-to-br from-purple-50 via-white to-pink-50 border-purple-200 rounded-3xl overflow-hidden relative hover:border-purple-300 transition-all shadow-md hover:shadow-xl">
              ...
              <CardContent className="p-8">
                ...
                <Button
                  ...
                  className="w-full bg-linear-to-r from-purple-600 to-pink-600 text-white hover:opacity-95 h-14 text-lg font-semibold rounded-2xl shadow-lg shadow-purple-100 transition-all"
                >
